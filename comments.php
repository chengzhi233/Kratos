...
?>">
	...
	<div id="<?php $comments->theId(); ?>" class="comment-body">
		<div class="comment-author vcard">
			<img alt="" src="<?php echo email_avatar($comments->mail) ?>" srcset="<?php echo email_avatar($comments->mail) ?> 2x" class="avatar avatar-50 photo" height="50" width="50"><cite class="fn"><?php echo $comments->author; ?></cite><span class="says">说道：</span>
		</div>		
