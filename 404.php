	...
	<div class="container">
		...
		<section id="main" class='col-md-12'>
			<article>
				...
				<div class="acs">
<h1 align="center">
	<img alt="404 NOT FOUND" src="<?php $this->options->themeUrl('images/404.png'); ?>" title="404"></h1>
<hr width="400">
<p class="no">404 NOT FOUND</p>
<p class="ASD">你寻找的网页似乎提桶跑路了</p>
</div>
				<p class="text-center"><a class="btn btn-primary" href="javascript:history.back(-1)">返回上页</a>&nbsp<a class="btn btn-primary" href="<?php $this->options ->siteUrl(); ?>">返回首页</a></p>
				</div></div>
			</article>
		</div>
	</div>
